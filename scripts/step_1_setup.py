...
from scripts.utils import balance_gene_sets, define_batch_size, save_step_runtime, str2enum
...
def setup(
    ...
    gene_sets = balance_gene_sets(gene_sets, processes)
    save_gene_sets(gene_sets, output)  # re-save in balanced order
