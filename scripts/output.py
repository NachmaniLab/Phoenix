...
def background_exists(background: str, cache_path: str | None = None) -> bool:
    ...
    return cache_path is not None and cache_path and os.path.exists(f'{cache_path}/{background}.yml') and os.path.getsize(f'{cache_path}/{background}.yml') > 0  # type: ignore[return-value]
